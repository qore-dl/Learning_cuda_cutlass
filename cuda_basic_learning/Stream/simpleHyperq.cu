...
/*
$./simpleHyperqDepth 4 1
CUDA_DEVICE_MAX_CONNECTIONS=32
> Using Device 0: Tesla V100-SXM2-16GB with num_streams=4
> Compute Capability 7.0 hardware with 80 multi-processors
> grid 8 block 512
Measured time for parallel execution = 0.000133s
(base) 
[admin@speed-web011161104112.na610 /data/notebooks/cuda_learning/hq/pro-cuda-c/charpter6]
$./simpleHyperqSeq 4 1
CUDA_DEVICE_MAX_CONNECTIONS=32
> Using Device 0: Tesla V100-SXM2-16GB with num_streams=4
> Compute Capability 7.0 hardware with 80 multi-processors
> grid 8 block 512
Measured time for parallel execution = 0.000164s
